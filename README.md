...
**Integration & Automation Engineer** building AI agent systems, data pipelines, and self-hosted infrastructure. Vancouver, BC.

I build systems that run themselves. My work focuses on automation pipelines, API integrations, and infrastructure that operates 24/7 without intervention.
...
| AI / LLM | Multi-provider orchestration, prompt engineering, agent workflows |
| Backend | FastAPI, SQLite, PostgreSQL, REST APIs, OAuth 2.0 |
| Infrastructure | Linux, Docker, systemd, Cloudflare Tunnel, Tailscale |
| Integration | REST API troubleshooting, vendor management, change impact assessment |

---

## Currently

Open to roles in **AI systems, automation, and integration engineering** in Vancouver, BC.
